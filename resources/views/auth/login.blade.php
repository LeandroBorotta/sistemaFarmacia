...
@section('content')
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.login_post') }}" method="POST" class="row g-3 needs-validation" novalidate>
            @csrf 
        ...
        <div class="col-12">
            <p class="small mb-0">Esqueceu-se da palavra-passe? 
            <a href="{{ url('forgot') }}">esqueceu a conta</a></p>
            </div>
        {{-- <div class="col-12">
            <p class="small mb-0">Não tem conta? <a href="#">Criar uma conta</a></p>
        </div> --}}
        </form>
