            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('insert.clientes') }}" method="POST" enctype="multipart/form-data">
                            @csrf 
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="address" cols="124" rows="5" class="form-control"></textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="doctor_address" cols="124" rows="5" class="form-control"></textarea>
